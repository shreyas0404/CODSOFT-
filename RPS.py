...
def outcome_handler(user_choice):
    ...
    if result == 2:
        ...
        player_point_label.config(text="Player : "+str(player_score))
        outcome_label.config(fg="darkgreen",text="Result : Player won")
    elif result == 1:
        player_score = player_score+1
        comp_score = comp_score+1
        player_point_label.config(text="Player : "+str(player_score))
        computer_point_label.config(text="Computer : "+str(comp_score))
...
player_point_label=Label(master,text="Player Score",font=("Times New Roman",12,"bold"))
player_point_label.grid(row=3,sticky=W)
player_point_label=Label(master,text="Player : 0",font=("Times New Roman",12,"bold"))
player_point_label.grid(row=4,sticky=W)
computer_point_label=Label(master,text="Computer Score",font=("Times New Roman",12,"bold"))
computer_point_label.grid(row=3,sticky=E)
computer_point_label=Label(master,text="Computer : 0",font=("Times New Roman",12,"bold"))
computer_point_label.grid(row=4,sticky=E)
...
outcome_label = Label(master,font=("Times New Roman",14,"bold"))
